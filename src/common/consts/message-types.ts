...
export const MessageTypeAskToConfirmFirstDayTasks = 25
...
export const MessageTypes = [
  ...
  MessageTypeAskToConfirmFirstDayTasks, MessageTypeAskForNextDayTasks, MessageTypeAskToConfirmNextDayTasks,
